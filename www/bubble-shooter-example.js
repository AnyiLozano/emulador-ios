window.onload = function () {
    ...
    function nextBubble() {
        ...
        console.log('Siguiente: ' + player.bubble.tiletype); // ** COLOR DE LA BURBUJA QUE SE LANZA
        /*
            Rojo: 0
            Azul: 1
            Morado: 2
    ...
    function shootBubble() {
        ...
        console.log('Disparada: ' + player.bubble.tiletype); // ** COLOR DE LA BURBUJA QUE SE LANZA
